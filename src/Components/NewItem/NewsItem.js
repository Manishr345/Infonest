...
export default function NewsItem(props) {
  return (
    <div className='bg-black mt-5 ml-5 text-white w-56 h-80 rounded-lg font-serif'>
      <div className='bg-black w-full h-28 rounded-t-lg'>
        <img className='rounded-t-lg w-full h-full' src={props.urlToImage?props.urlToImage:'https://i0.wp.com/9to5mac.com/wp-content/uploads/sites/6/2024/07/apple-device-lineup.jpg?w=1500&quality=82&strip=all&ssl=1'} alt='no image'/>
      </div>
      <div>
