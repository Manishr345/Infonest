...
export default function Categories() {
  return (
    <div className='categories flex space-x-40'>
      <div className='flex text-white'>
        <div className='catitem ml-3 flex space-x-2'>
        ...
        <button className='pr-2' href='/'>Business</button>
        </div>
        <div className='catitem ml-32 navhover flex space-x-2'>
        ...
        <button className='pr-2' href='/'>Entertainment</button>
        </div>
        <div className='catitem ml-32 navhover flex space-x-2'>
        ...
        <button className='pr-2' href='/'>General</button>
        </div>
        <div className='catitem ml-32 navhover flex space-x-2'>
        ...
        <button className='pr-2'>Health</button>
        </div>
      </div>
    </div>
  )
