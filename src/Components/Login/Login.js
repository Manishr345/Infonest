    ...
    return (
        props.isLogin && <div className='flex ml-40 mt-10 rounded-xl w-[1000px] h-[500px]' style={{ backgroundColor: '#F8ECE6', fontFamily: "'Signika Negative', 'sans-serif'" }}>
            ...
            <div className='pt-10 ml-8'>
                <p className='text-left mb-2 text-lg font-serif pl-11'>Log in</p>
                <input className='bg-black pl-2 ml-8 w-96 text-white h-8 font-mono mb-2 rounded-md' placeholder='UserName' />
                <br />
                <input className='bg-black pl-2 ml-8 w-96 text-white h-8 font-mono mb-2 rounded-md' placeholder='Password' />
                <br />
                <Link to='/home'><button className='bg-green-900 ml-8 text-white h-8 font-mono w-96 rounded-md mb-2 ' onClick={props.doneLogin}>Continue</button></Link>
                <br />
                ...
                <button className='bg-blue-500 w-96 rounded-md ml-11 pl-3 text-white h-8 pt-1 flex mb-3'>
                    ...
                    <p className='ml-20'>Log in with twitter</p>
                </button>
                <button className='bg-black w-96 rounded-md ml-11 pl-3 text-white h-8 pt-1 flex mb-3'>
                ...
                <button className='bg-blue-950 w-96 rounded-md ml-11 pl-3 text-white h-8 pt-1 flex mb-2'>
                ...
                <Link to='/signup'><p>Do not have account?</p></Link>
            </div>
        </div>
    )
}
