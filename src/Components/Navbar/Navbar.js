  ...
  return (
    props.setHome && <div className='navbar flex space-x-40'>
      ...
      <div className='flex text-white'>
        <div className='navitem home ml-3 flex space-x-2'>
        ...
        <div className='navitem ml-32 navhover flex space-x-2'>
        ...
        <button className='pr-2' onClick={props.onCat}>Categories</button>
        </div>
      </div>
    </div>
  )
